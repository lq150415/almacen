				...
				<table >
					...
					<table>
						<tr style="height:30px;">
							...
							<td width="240px"><input type="text" name="nic_usu" value="" class="txtcampo large" placeholder="NOMBRE DE USUARIO" onpaste="return false"></td>
						...
						<tr style="height:30px;">
							<td width="100px" class="lblnombre">REPITA EL PASSWORD</td>
